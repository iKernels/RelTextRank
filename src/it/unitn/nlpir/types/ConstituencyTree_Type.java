 ...
 * @generated */
public class ConstituencyTree_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (ConstituencyTree_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = ConstituencyTree_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new ConstituencyTree(addr, ConstituencyTree_Type.this);
  			   ConstituencyTree_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new ConstituencyTree(addr, ConstituencyTree_Type.this);
  	  }
    };
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.unitn.nlpir.types.ConstituencyTree");
  ...
  public String getTree(int addr) {
      ...
      jcas.throwFeatMissing("tree", "it.unitn.nlpir.types.ConstituencyTree");
