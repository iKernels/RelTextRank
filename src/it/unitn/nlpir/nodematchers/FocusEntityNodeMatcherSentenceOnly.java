 ...
 * 
 */
public class FocusEntityNodeMatcherSentenceOnly implements NodeMatcher {
	private final static Logger logger = LoggerFactory.getLogger(FocusEntityNodeMatcherSentenceOnly.class);
	...
	public FocusEntityNodeMatcherSentenceOnly(MatchingStrategy strategy) {
		this(strategy, defaultRelTag, false);
	}
	
	public FocusEntityNodeMatcherSentenceOnly(MatchingStrategy strategy, boolean typedRelTag) {
		this(strategy, defaultRelTag, typedRelTag);
	}
	
	public FocusEntityNodeMatcherSentenceOnly(MatchingStrategy strategy, String relTag, boolean typedRelTag) {
