 ...
 * 
 */
public class FocusEntityNodeMatcherEntyMappingFixed implements NodeMatcher {
	private final static Logger logger = LoggerFactory.getLogger(FocusEntityNodeMatcherEntyMappingFixed.class);
	...
	public FocusEntityNodeMatcherEntyMappingFixed(MatchingStrategy strategy) {
		this(strategy, defaultRelTag, false);
	}
	
	public FocusEntityNodeMatcherEntyMappingFixed(MatchingStrategy strategy, boolean typedRelTag) {
		this(strategy, defaultRelTag, typedRelTag);
	}
	
	public FocusEntityNodeMatcherEntyMappingFixed(MatchingStrategy strategy, String relTag, boolean typedRelTag) {
