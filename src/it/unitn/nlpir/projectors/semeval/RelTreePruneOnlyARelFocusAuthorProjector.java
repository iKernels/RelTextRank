...
public class RelTreePruneOnlyARelFocusAuthorProjector extends RelTreePruneBothQARelFocusAuthorProjector implements Projector {
	

	public RelTreePruneOnlyARelFocusAuthorProjector(TreeBuilder treeBuilder, int numPreRootNodesToKeep) {
		super(treeBuilder,numPreRootNodesToKeep);
		
	}
	
	public RelTreePruneOnlyARelFocusAuthorProjector(TreeBuilder treeBuilder, NodeMatcher matcher, NodeMatcher focusMatcher, 
