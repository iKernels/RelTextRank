 ...
 *
 */
public class IRAllFeatsChpNewBslFeatNoPruneExperiment extends StanfordAETrecQAWithQCExperiment {
	
	
	public IRAllFeatsChpNewBslFeatNoPruneExperiment(String configFile) {
		super(configFile);
	}
