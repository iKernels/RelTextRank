 ...
 *
 */
public class IRAllFeatsNoQCChpNewBslFeatNoPruneExperiment extends StanfordAETrecQAWithQCExperiment {
	
	
	public IRAllFeatsNoQCChpNewBslFeatNoPruneExperiment(String configFile) {
		super(configFile);
	}
	...
	protected void setupFeatures() {
		...
		.extend(FeatureSets.buildDocumentRankingScoreFeatures())
