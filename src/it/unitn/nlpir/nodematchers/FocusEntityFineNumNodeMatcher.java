 ...
 * 
 */
public class FocusEntityFineNumNodeMatcher implements NodeMatcher {
	private final static Logger logger = LoggerFactory.getLogger(FocusEntityFineNumNodeMatcher.class);
	...
	private boolean markQuestionTag;

	public FocusEntityFineNumNodeMatcher(MatchingStrategy strategy) {
		this(strategy, defaultRelTag, false, false);
	}
	
	public FocusEntityFineNumNodeMatcher(MatchingStrategy strategy, boolean typedRelTag) {
		this(strategy, defaultRelTag, typedRelTag,false);
	}
	
	public FocusEntityFineNumNodeMatcher(MatchingStrategy strategy, boolean typedRelTag, boolean markQuestionTag) {
		this(strategy, defaultRelTag, typedRelTag, markQuestionTag);
	}
	
	public FocusEntityFineNumNodeMatcher(MatchingStrategy strategy, String relTag, boolean typedRelTag, boolean markQuestionTag) {
