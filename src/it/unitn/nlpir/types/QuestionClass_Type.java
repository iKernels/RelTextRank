 ...
 * @generated */
public class QuestionClass_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.unitn.nlpir.types.QuestionClass");
  ...
  public String getQuestionClass(int addr) {
      ...
      jcas.throwFeatMissing("questionClass", "it.unitn.nlpir.types.QuestionClass");
  ...
  public double getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "it.unitn.nlpir.types.QuestionClass");
