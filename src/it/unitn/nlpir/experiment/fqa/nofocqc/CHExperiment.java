package it.unitn.nlpir.experiment.fqa.nofocqc;
...
public class CHExperiment extends StanfordAETrecQAWithQCExperiment {
	...
	protected void setupProjector() {
		...
		this.projector = Projectors.getProjector(new PosChunkTreeBuilder(), pruningRay, new StartsWithOrContainsTagPruningRule(), new TreeLeafFinalizer());
