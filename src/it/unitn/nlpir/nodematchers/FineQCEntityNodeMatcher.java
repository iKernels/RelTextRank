 ...
 * 
 */
public class FineQCEntityNodeMatcher implements NodeMatcher {
	private final static Logger logger = LoggerFactory.getLogger(FineQCEntityNodeMatcher.class);
	...
	public FineQCEntityNodeMatcher(MatchingStrategy strategy) {
		this(strategy, defaultRelTag, false);
	}
	
	public FineQCEntityNodeMatcher(MatchingStrategy strategy, boolean typedRelTag) {
		this(strategy, defaultRelTag, typedRelTag);
	}
	
	public FineQCEntityNodeMatcher(MatchingStrategy strategy, String relTag, boolean typedRelTag) {
