...
void perceptron_learn_classification(DOC *, double *, long, long, LEARN_PARM *, 
				KERNEL_PARM *, KERNEL_CACHE *, MODEL *, char *);
void batch_perceptron_learn_classification(DOC *, double *, long, long, LEARN_PARM *, 
				KERNEL_PARM *, int , MODEL *);
