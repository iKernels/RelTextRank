...
/**
 * <li> CH + FOCUS + REL, CH without pos, QC dangling
 ...
 *
 */
public class CachedFeatsCHTypedFocusStanfordDangleQCTreshFocForSPTKExperiment  extends TrecQAExperiment implements IFeatsFromFile  {
	
	protected static final Logger logger = LoggerFactory.getLogger(CachedFeatsCHTypedFocusStanfordDangleQCTreshFocForSPTKExperiment.class);
	
	protected String modelsFile;
	private final String MODELS_FILE = "data/question-classifier/lct-dep-fine/expsptk_fine_sptk_lsa";
	
	
	protected void setupLODProjector() {
		this.pruningRay = -1;
		logger.info("Setting up a projector");
		this.projector = Projectors.getFocusWithThreshFocusUntypedFocusInQProjector(new PosChunkTreeBuilder(),
				pruningRay,
