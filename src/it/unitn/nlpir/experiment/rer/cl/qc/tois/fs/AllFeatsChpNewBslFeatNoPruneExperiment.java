 ...
 *
 */
public class AllFeatsChpNewBslFeatNoPruneExperiment extends StanfordAETrecQAWithQCExperiment {
	
	
	public AllFeatsChpNewBslFeatNoPruneExperiment(String configFile) {
		super(configFile);
	}
