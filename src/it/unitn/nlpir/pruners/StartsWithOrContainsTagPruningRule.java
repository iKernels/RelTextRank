 ...
 *
 */
public class StartsWithOrContainsTagPruningRule implements PruningRule {
	
	private final String [] tags;
	private final String[] tagsToFilter;
	public StartsWithOrContainsTagPruningRule(String [] tags, String[] tagsToFilter){
		this.tags = tags;
		this.tagsToFilter = tagsToFilter;
	}
	
	public StartsWithOrContainsTagPruningRule(){
	...
	private boolean isSatisfied(Tree node){
		...
		boolean satisfied = ( customTag != null);
		if (!satisfied){
