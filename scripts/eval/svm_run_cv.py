...
if __name__ == '__main__':
  ...
  desc = "arg: folder with the cross-validation fold subfolders generated by the System"
  ...
  parser.add_option('-s', '--suf', help='suffix to add to the model and prediction file names, '
                                        'i.e model will be named svm_SUF.model',
                    dest='suf', default="")
  parser.add_option('-e', '--skip_eval', help='Do not do evaluation',
                    dest='skip_eval', default=False, action='store_true')
