 ...
 *
 */
public class AllFeatsNoQCChpNewBslFeatNoPruneExperiment extends StanfordAETrecQAWithQCExperiment {
	
	
	public AllFeatsNoQCChpNewBslFeatNoPruneExperiment(String configFile) {
		super(configFile);
	}
