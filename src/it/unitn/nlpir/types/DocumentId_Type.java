...
public class DocumentId_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("it.unitn.nlpir.types.DocumentId");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "it.unitn.nlpir.types.DocumentId");
