package it.unitn.nlpir.nodematchers.sandbox;
 ...
 * 
 */
public class GRHardNodeMatcher implements NodeMatcher {
	protected final Logger logger = LoggerFactory.getLogger(GRHardNodeMatcher.class);
	...
	public GRHardNodeMatcher(MatchingStrategy strategy) {
		this(defaultMatchingTokenTextType, defaultRelTag, strategy);
	}

	
	
	public GRHardNodeMatcher(String matchingTokenTextType, String relTag, MatchingStrategy strategy) {
