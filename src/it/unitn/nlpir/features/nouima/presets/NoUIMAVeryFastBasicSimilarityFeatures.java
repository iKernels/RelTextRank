 ...
 *
 */
public class NoUIMAVeryFastBasicSimilarityFeatures implements INoUIMAVectorFeatureExtractor{
	...
	public NoUIMAFeaturesBuilder getFeaturesBuilder() {
		...
		.add(new NoUIMACosineSimilarity(new NoUIMADependencyTripletsProvider(
				PlainToken.LEMMA))) 
		.extend(NoUIMAFeatureSets.buildDKProWordOverlapFeaturesNoTiling());
	}
}
